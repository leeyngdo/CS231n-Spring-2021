...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, cache3 = affine_relu_forward(out, W3, b3)
        ...
        dout, dw3, db3 = affine_relu_backward(dout, cache3)
        dout, dw2, db2 = affine_relu_backward(dout, cache2)
        dout, dw1, db1 = conv_relu_pool_backward(dout, cache1)
        
        grad['W1'] = dw1 + self.reg * W1
        grad['W2'] = dw2 + self.reg * W2
        grad['W3'] = dw3 + self.reg * W3
